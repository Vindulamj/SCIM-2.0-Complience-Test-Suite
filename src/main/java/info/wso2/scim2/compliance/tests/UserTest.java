...
public class UserTest{
    ...
    private TestResult CreateUserTest () throws GeneralComplianceException, ComplianceException {
    ...
    private TestResult UpdateUserTest () throws GeneralComplianceException, ComplianceException {
    ...
    private TestResult PatchUserTest () throws GeneralComplianceException, ComplianceException {
        ...
        HttpPatch method = new HttpPatch(updateUserURL);
        //create user test
        HttpClient client = HTTPClient.getHttpClientWithBasicAuth();
    ...
    private TestResult DeleteUserTest () throws GeneralComplianceException, ComplianceException {
        ...
        HttpDelete method = new HttpDelete(updateUserURL);
        //create user test
        HttpClient client = HTTPClient.getHttpClientWithBasicAuth();
