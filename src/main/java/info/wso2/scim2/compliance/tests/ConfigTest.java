...
import info.wso2.scim2.compliance.protocol.CSP;
...
public class ConfigTest {
    ...
    public TestResult getConfiguration(CSP csp) throws Exception {
        String url = csp.getUrl() + csp.getVersion() + "/ServiceProviderConfig";

        GetMethod method = null;
        method = new GetMethod(url);

        // create client with the correct authn for server
        HttpClient client = ComplienceUtils.getHttpClientWithAuth(null, method);
    ...
    public TestResult getSchema(String type, CSP csp) throws Exception {
        ...
        // create client with the correct authn for server
        HttpClient client = null;//ComplienceUtils.getHttpClientWithAuth(csp, method);
