...
import info.wso2.scim2.compliance.entities.AuthMetod;
...
public class ComplienceUtils {
	...
	public static HttpClient getHttpClientWithAuth(info.simplecloud.scimproxy.compliance.CSP csp, HttpMethodBase method) {
